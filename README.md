...
Open `.env` in your code editor and fill in your details for either the reaction or pool:

```env
# Required: Your Discord Bot Token (from Discord Developer Portal)
DISCORD_BOT_TOKEN=your_bot_token_here

# Required: Server ID, Message/Poll ID, and Role ID for the particular message to react or poll to vote, for example👇
